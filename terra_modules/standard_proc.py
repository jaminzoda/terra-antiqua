        ...
        if processing_type == 0:
            ...
            if not self.killed:
                ...
                if self.dlg.smoothingBox.isChecked():
                    ...
                    # Smooth the raster
                    rasterSmoothing(interpolated_raster_layer, sm_type, sm_factor, feedback=self, runtime_percentage=78)
            ...
            if not self.killed:
                ...
                smoothed_raster_layer = rasterSmoothing(raster_to_smooth_layer, smoothing_type, smoothing_factor, out_file_path,
                                                            feedback = self)
