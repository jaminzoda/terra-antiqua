...
class VectorTools(QgsVectorLayer):
    ...
    def vector_to_raster(self, geotransform, width, height, field_to_burn=None, no_data=None, burn_value=None):
        """
    ...
    def vector_to_raster_old(self, geotransform, ncols, nrows):
        """
        Rasterizes a vector layer and returns a numpy array.
